...
create table tb_order (order_status integer, client_id bigint, id bigserial not null, moment timestamp(6) with time zone, primary key (id));
...
create table tb_product (price float(53), id bigserial not null, description varchar(255), img_url varchar(255), name varchar(255), primary key (id));
